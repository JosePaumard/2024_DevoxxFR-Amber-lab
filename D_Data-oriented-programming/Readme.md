...
To start this refactoring, you can checkout the `DOP_Refactor-step00` branch of this Git repository.
...
You can access the state of the code base at this step by checkouting the `DOP_Refactor-step02` of this Git repository.
...
To start this refactoring, you can checkout the `DOP_Refactor-step02` branch of this Git repository.
...
You can access the state of the code base at this step by checkouting the `DOP_Refactor-step04` of this Git repository.
